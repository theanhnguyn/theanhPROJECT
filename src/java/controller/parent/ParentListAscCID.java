 ...
 * @author FPTSHOP
 */
public class ParentListAscCID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Parent> parents = dbParent.getParentsByCID(mid);
        request.setAttribute("parents", parents);
        request.setAttribute("customers", customers);
        request.setAttribute("mid", mid);
        //response.getWriter().println("Check:" + customers.size());
        request.getRequestDispatcher("../view/customer/listCID.jsp").forward(request, response);
    }
