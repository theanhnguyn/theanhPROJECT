 ...
 * @author FPTSHOP
 */
public class ListAscDobController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Customer> customers = dbCustomer.getCustomerByDob(mid);
        ...
        request.getRequestDispatcher("../view/customer/listDOB.jsp").forward(request, response);
    }
