 ...
 * @author FPTSHOP
 */
public class ListAscIDController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Customer> customers = dbCustomer.getCustomerById(mid);
        ...
        request.getRequestDispatcher("../view/customer/listID.jsp").forward(request, response);
    }
